import Circleui from '../circleui/circleui'
import './mainTop.css'
const mainTop = () => {
  return (
    <div className='w-full flex justify-center mt-16'>
      <div className='w-[95%] rounded-2xl  bg-slate-50'>
        ...
        <div className='grid sm:grid-cols-3 lg:flex w-full justify-center items-center gap-3 '>
        <Circleui  color={'text-red-600'} text={'چالش‌برانگیز'}>
        ...
        <Circleui  color={'text-yellow-600'} text={'پروژه‌محور'}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-8 h-8">
        ...
        <Circleui  color={'text-blue-600'} text={'جامع'}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-8 h-8">
                <path d="M10.75 16.82A7.462 7.462 0 0 1 15 15.5c.71 0 1.396.098 2.046.282A.75.75 0 0 0 18 15.06v-11a.75.75 0 0 0-.546-.721A9.006 9.006 0 0 0 15 3a8.963 8.963 0 0 0-4.25 1.065V16.82ZM9.25 4.065A8.963 8.963 0 0 0 5 3c-.85 0-1.673.118-2.454.339A.75.75 0 0 0 2 4.06v11a.75.75 0 0 0 .954.721A7.506 7.506 0 0 1 5 15.5c1.579 0 3.042.487 4.25 1.32V4.065Z">
                </path>
            </svg>
        </Circleui>
        <Circleui  color={'text-green-600'} text={'به‌روز'}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-8 h-8">
        ...
        <Circleui color={'text-red-600'} text={'ویدیویی'}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-8 h-8">
                <path d="M3.25 4A2.25 2.25 0 0 0 1 6.25v7.5A2.25 2.25 0 0 0 3.25 16h7.5A2.25 2.25 0 0 0 13 13.75v-7.5A2.25 2.25 0 0 0 10.75 4h-7.5ZM19 4.75a.75.75 0 0 0-1.28-.53l-3 3a.75.75 0 0 0-.22.53v4.5c0 .199.079.39.22.53l3 3a.75.75 0 0 0 1.28-.53V4.75Z">
                </path>
            </svg>
        </Circleui>
        <Circleui  color={'text-teal-400'} text={'منتورشیپ'}>
        <svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className=" w-8 h-8">
