  ...
  return (
    ...
    <div className="w-4/5 bg-white rounded-xl border h-full justify-between flex items-center">
        ...
        <div className="flex gap-2 h-full">
            ...
            {
              ses.free?<div className="bg-slate-200 rounded-xl opacity-70 w-fit flex justify-between h-full hover:text-blue-700 transition-all cursor-pointer items-center px-2">
          ...
          }} className="bg-slate-200 rounded-xl opacity-70 w-fit flex justify-between h-full hover:text-red-700 transition-all cursor-pointer items-center px-2">
