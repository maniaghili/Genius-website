...
const MainBottom = () => {
  return (
    <div className="w-full flex justify-center items-center ">
      <div className="w-[95%] bg-slate-200 rounded-2xl mt-28 flex items-center h-64">
        <div className="lg:w-1/3 flex ">
           <div className="bg-blue-700 w-12 h-12 rounded-full flex justify-center items-center ">
           ...
           <div>
            <h2 className="text-blue-700 font-bold">در مورد نابغه چه میشنویم؟</h2>
